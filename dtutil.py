...
def get_timedelta_string(delta):
    ...
    hours_string = "{}h".format(hours) if minutes == 0 and seconds == 0 else "{}".format(hours)
    hours_string = "" if hours == 0 and minutes == 0 and seconds == 0 else hours_string
    minute_string = ":0{}".format(minutes) if minutes < 10 else ":{}".format(minutes)
    minute_string = "" if minutes == 0 and seconds == 0 else minute_string

    delta_string = "{} {}{}{}".format(days_string, hours_string, minute_string, seconds_string)
    return delta_string
